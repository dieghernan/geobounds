...
The **geobounds** package provides an **R**-friendly interface for accessing the
[**geoBoundaries**](https://www.geoboundaries.org/) Global Database of Political
Administrative Boundaries. Using this package, you can:
...
- **gbAuthoritative**: Boundaries mirrored from UN SALB and verified through
  in-country processes. These boundaries cannot be used for commercial purposes.
