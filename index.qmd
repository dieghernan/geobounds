...
- Download individual country files and global composite files
  from **geoBoundaries**.
...
restrictions, so check the boundary metadata returned by `gb_get_metadata()`
before reuse.
...
- Thanks to the **R** package community and all contributors to this package’s
  development.
- If you use **geobounds** and the underlying **geoBoundaries** data, please
  cite both.
