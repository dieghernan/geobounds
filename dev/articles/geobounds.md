...
#>   <chr>        <chr>                                                <chr>             
#> 1 India        CC0 1.0 Universal (CC0 1.0) Public Domain Dedication geoBoundaries, Wi…
#> 2 Pakistan     Open Data Commons Open Database License 1.0          OpenStreetMap, Wa…
```
...
#> → Cache dir is 'C:\Users\diego\AppData\Local\Temp\RtmpI98Slw//geoboundvignette/gbOpen'
...
#> $ Continent            <chr> "Latin America and the Caribbean", "Latin America and t…
