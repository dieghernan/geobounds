...
#> ℹ 'C:\Users\RUNNER~1\AppData\Local\Temp\RtmpyC73Su'

current
#> [1] "C:\\Users\\RUNNER~1\\AppData\\Local\\Temp\\RtmpyC73Su"

# Change to new
newdir <- file.path(tempdir(), "/geoboundvignette")
gb_set_cache_dir(newdir)
#> ✔ geobounds cache dir is 'C:\Users\RUNNER~1\AppData\Local\Temp\RtmpyC73Su//geoboundvignette'.
...
#> → Cache dir is 'C:\Users\RUNNER~1\AppData\Local\Temp\RtmpyC73Su//geoboundvignette/gbOpen'

# Restore cache dir
gb_set_cache_dir(current)
#> ✔ geobounds cache dir is 'C:\Users\RUNNER~1\AppData\Local\Temp\RtmpyC73Su'.
#> ℹ To install your `cache_dir` path for use in future sessions run this function with `install = TRUE`.
