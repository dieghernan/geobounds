...
#> ℹ 'C:\Users\diego\AppData\Local\Temp\Rtmpm6VNrx'

current
#> [1] "C:\\Users\\diego\\AppData\\Local\\Temp\\Rtmpm6VNrx"

# Change to new
newdir <- file.path(tempdir(), "/geoboundvignette")
gb_set_cache_dir(newdir)
#> ✔ geobounds cache dir is 'C:\Users\diego\AppData\Local\Temp\Rtmpm6VNrx//geoboundvignette'.
...
#> → Cache dir is 'C:\Users\diego\AppData\Local\Temp\Rtmpm6VNrx//geoboundvignette/gbOpen'

# Restore cache dir
gb_set_cache_dir(current)
#> ✔ geobounds cache dir is 'C:\Users\diego\AppData\Local\Temp\Rtmpm6VNrx'.
#> ℹ To install your `cache_dir` path for use in future sessions run this function with `install = TRUE`.
