...
#> ℹ 'C:\Users\diego\AppData\Local\Temp\RtmpAbXZSy'

current
#> [1] "C:\\Users\\diego\\AppData\\Local\\Temp\\RtmpAbXZSy"

# Change to new
newdir <- file.path(tempdir(), "/geoboundvignette")
gb_set_cache_dir(newdir)
#> ✔ geobounds cache dir is 'C:\Users\diego\AppData\Local\Temp\RtmpAbXZSy//geoboundvignette'.
#> ℹ To install your `cache_dir` path for use in future sessions run this function with `install = TRUE`.

# Download
example <- get_gb_adm0("Vatican City", quiet = FALSE)
#> ✔ File 'C:\Users\diego\AppData\Local\Temp\RtmpAbXZSy/geoboundvignette/gbOpen/geoBoundaries-VAT-ADM0.geojson' already cached

# Restore cache dir
gb_set_cache_dir(current)
#> ✔ geobounds cache dir is 'C:\Users\diego\AppData\Local\Temp\RtmpAbXZSy'.
#> ℹ To install your `cache_dir` path for use in future sessions run this function with `install = TRUE`.
