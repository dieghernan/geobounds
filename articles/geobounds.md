...
#> ℹ 'C:\Users\diego\AppData\Local\Temp\RtmpqILKNw'

current
#> [1] "C:\\Users\\diego\\AppData\\Local\\Temp\\RtmpqILKNw"

# Change to new
newdir <- file.path(tempdir(), "/geoboundvignette")
gb_set_cache_dir(newdir)
#> ✔ geobounds cache dir is 'C:\Users\diego\AppData\Local\Temp\RtmpqILKNw//geoboundvignette'.
#> ℹ To install your `cache_dir` path for use in future sessions run this function with `install = TRUE`.

# Download
example <- gb_get_adm0("Vatican City", quiet = FALSE)
#> ✔ File 'C:\Users\diego\AppData\Local\Temp\RtmpqILKNw/geoboundvignette/gbOpen/geoBoundaries-VAT-ADM0-all.zip' already cached

# Restore cache dir
gb_set_cache_dir(current)
#> ✔ geobounds cache dir is 'C:\Users\diego\AppData\Local\Temp\RtmpqILKNw'.
#> ℹ To install your `cache_dir` path for use in future sessions run this function with `install = TRUE`.
...
#> Rows: 47
#> Columns: 4
#> $ boundaryISO          <chr> "ABW", "AIA", "ARG", "ATG", "BES", "BHS", "BLM", "B…
#> $ boundaryName         <chr> "Aruba", "Anguilla", "Argentina", "Antigua and Barb…
#> $ Continent            <chr> "Latin America and the Caribbean", "Latin America a…
