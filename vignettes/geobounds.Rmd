...
current
#> [1] "C:\\Users\\RUNNER~1\\AppData\\Local\\Temp\\RtmpiAzJoY"

# Change to new
newdir <- file.path(tempdir(), "/geoboundvignette")
geobn_set_cache_dir(newdir)
#> ℹ geobounds cache dir is 'C:\Users\RUNNER~1\AppData\Local\Temp\RtmpiAzJoY//geoboundvignette'.
...
#> ℹ Cache dir is 'C:\Users\RUNNER~1\AppData\Local\Temp\RtmpiAzJoY//geoboundvignette/gbOpen'

# Restore cache dir
geobn_set_cache_dir(current)
#> ℹ geobounds cache dir is 'C:\Users\RUNNER~1\AppData\Local\Temp\RtmpiAzJoY'.
#> ℹ To install your `cache_dir` path for use in future sessions run this function with `install = TRUE`.
