...
#>   <chr>        <chr>                                    <chr>         
#> 1 India        CC0 1.0 Universal (CC0 1.0) Public Doma… geoBoundaries…
#> 2 Pakistan     Open Data Commons Open Database License… OpenStreetMap…
```
...
#> ℹ 'C:\Users\diego\AppData\Local\Temp\RtmpoxVWR3'

current
#> [1] "C:\\Users\\diego\\AppData\\Local\\Temp\\RtmpoxVWR3"

# Change to new
newdir <- file.path(tempdir(), "/geoboundvignette")
gb_set_cache_dir(newdir)
#> ✔ geobounds cache dir is 'C:\Users\diego\AppData\Local\Temp\RtmpoxVWR3//geoboundvignette'.
...
#> → Cache dir is 'C:\Users\diego\AppData\Local\Temp\RtmpoxVWR3//geoboundvignette/gbOpen'

# Restore cache dir
gb_set_cache_dir(current)
#> ✔ geobounds cache dir is 'C:\Users\diego\AppData\Local\Temp\RtmpoxVWR3'.
#> ℹ To install your `cache_dir` path for use in future sessions run this function with `install = TRUE`.
...
#> Rows: 47
#> Columns: 4
#> $ boundaryISO          <chr> "ABW", "AIA", "ARG", "ATG", "BES", "BHS…
#> $ boundaryName         <chr> "Aruba", "Anguilla", "Argentina", "Anti…
#> $ Continent            <chr> "Latin America and the Caribbean", "Lat…
#> $ worldBankIncomeGroup <chr> "High-income Countries", "No income gro…
