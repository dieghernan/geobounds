...
current
#> [1] "C:\\Users\\RUNNER~1\\AppData\\Local\\Temp\\RtmpWCThwP"

# Change to new
newdir <- file.path(tempdir(), "/geoboundvignette")
geobn_set_cache_dir(newdir)
#> ℹ geobounds cache dir is 'C:\Users\RUNNER~1\AppData\Local\Temp\RtmpWCThwP//geoboundvignette'.
...
#> ℹ Cache dir is 'C:\Users\RUNNER~1\AppData\Local\Temp\RtmpWCThwP//geoboundvignette/gbOpen'

# Restore cache dir
geobn_set_cache_dir(current)
#> ℹ geobounds cache dir is 'C:\Users\RUNNER~1\AppData\Local\Temp\RtmpWCThwP'.
#> ℹ To install your `cache_dir` path for use in future sessions run this function with `install = TRUE`.
