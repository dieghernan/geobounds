...
vary in validation levels and licensing. With **geobounds**, you can
...
removing overlaps and filling gaps), please use `gb_get_cgaz()`. This function
downloads global composite datasets for administrative boundaries, also known
as CGAZ (Comprehensive Global Administrative Zones). There are three important
...
#> ℹ ']8;;file://C:\Users\diego\AppData\Local\Temp\Rtmp65m814C:\Users\diego\AppData\Local\Temp\Rtmp65m814]8;;'
...
#> ✔ geobounds cache dir is ']8;;file://C:\Users\diego\AppData\Local\Temp\Rtmp65m814//geoboundvignetteC:\Users\diego\AppData\Local\Temp\Rtmp65m814//geoboundvignette]8;;'.
#> ℹ To install your `cache_dir` path for use in future sessions run this function with `install = TRUE`.

# Download
example <- gb_get_adm0("Vatican City", quiet = FALSE)
#> ℹ Downloading file from <]8;;https://github.com/wmgeolab/geoBoundaries/raw/9469f09/releaseData/gbOpen/VAT/ADM0/geoBoundaries-VAT-ADM0-all.ziphttps://github.com/wmgeolab/geoBoundaries/raw/9469f09/releaseData/gbOpen/VAT/ADM0/geoBoundaries-VAT-ADM0-all.zip]8;;>
#> → Cache dir is ']8;;file://C:\Users\diego\AppData\Local\Temp\Rtmp65m814//geoboundvignette/gbOpenC:\Users\diego\AppData\Local\Temp\Rtmp65m814//geoboundvignette/gbOpen]8;;'

# Restore cache dir
gb_set_cache_dir(current)
#> ✔ geobounds cache dir is ']8;;file://C:\Users\diego\AppData\Local\Temp\Rtmp65m814C:\Users\diego\AppData\Local\Temp\Rtmp65m814]8;;'.
#> ℹ To install your `cache_dir` path for use in future sessions run this function with `install = TRUE`.
