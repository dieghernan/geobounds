---
title: "geobounds: Downloading administrative boundary data in R"
description: "Download, inspect and map administrative boundary data"
bibliography: REFERENCES.bib
link-citations: true
vignette: >
  %\VignetteIndexEntry{geobounds: Downloading administrative boundary data in R}
...
Use `gb_get_world()` for global composite files that standardize disputed areas
and fill gaps between borders. These files are also known as Comprehensive
Global Administrative Zones (CGAZ). They differ from individual country files in
...
The package stores downloaded files in a cache directory so repeated requests
...
caching and visualizing administrative boundary data. The returned **sf**
objects can be used directly in mapping, spatial analysis and data integration
workflows.
