---
title: "geobounds: Download administrative boundary data in R"
description: "Download, inspect and map administrative boundary data"
bibliography: REFERENCES.bib
link-citations: true
vignette: >
  %\VignetteIndexEntry{geobounds: Download administrative boundary data in R}
...
The package code is MIT licensed. Downloaded data and figures derived from them
retain the licenses and attribution requirements of **geoBoundaries** and their
original sources. Check the boundary metadata before reuse.
...
files](https://www.geoboundaries.org/countryDownloads.html) that reflect how
...
CGAZ data and figures are not covered by the package's MIT License. Follow the
citation and use information included in each downloaded CGAZ archive.
...
Because boundary data are returned as `sf` objects, you can combine them with
other spatial data:
...
caching and visualizing administrative boundary data. The returned `sf` objects
