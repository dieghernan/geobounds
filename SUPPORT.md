...
Thanks for using geobounds! Before filing an issue, there are a few
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/dieghernan/geobounds/issues/new).
...
requests](https://github.com/dieghernan/geobounds/issues) to make sure
