...
gb_set_cache_dir(ex)
#> ✔ geobounds cache directory is /tmp/Rtmp5u0WhH/example/cachenew.
#> ℹ To use this cache directory in future sessions, call `gb_set_cache_dir()` with `install = TRUE`.

gb_detect_cache_dir()
#> ℹ /tmp/Rtmp5u0WhH/example/cachenew
#> [1] "/tmp/Rtmp5u0WhH/example/cachenew"
