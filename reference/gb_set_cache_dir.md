...
gb_set_cache_dir(ex)
#> ✔ geobounds cache directory is /tmp/RtmpTW5jPS/example/cachenew.
#> ℹ To use this cache directory in future sessions, run this function with `install = TRUE`.

gb_detect_cache_dir()
#> ℹ /tmp/RtmpTW5jPS/example/cachenew
#> [1] "/tmp/RtmpTW5jPS/example/cachenew"

# Restore the initial cache.
gb_set_cache_dir(my_cache)
#> ✔ geobounds cache directory is /tmp/RtmpTW5jPS/geobounds.
#> ℹ To use this cache directory in future sessions, run this function with `install = TRUE`.
