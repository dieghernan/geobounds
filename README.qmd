...
sharing **geoBoundaries** boundaries or derived products.
:::
...
`boundarySourceURL`. Always acknowledge **geoBoundaries**. Consult these fields
for any additional source attribution, license link, share-alike notice or
modification statement required by the boundary's license.
