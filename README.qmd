...
- **gbAuthoritative**: Official government boundaries with the highest accuracy
  but possible restrictions.
...
boundary data accessed through **geoBoundaries** also uses open licenses, so
...
- If you use **geobounds** and the underlying **geoBoundaries** data in your
  research or project, a citation and acknowledgment is greatly appreciated.
